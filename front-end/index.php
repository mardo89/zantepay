  ...
  <![endif]-->
      ...
      <div class="header__content white-content">
        <div class="container">
          ...
          <div class="horizontal-btns">
            <a href="https://cobinhood.com/" target="_blank" class="btn btn--shadowed-dark btn--260">Whitepaper</a>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 offset-lg-1 col-md-6">
              ...
              <div class="text">Interested in getting started with cryptocurrencies? Zantepay provides 50+ cryptocurrencies wallet, automatic highest market price convert to pay with VISA debit card with USD/EUR everywhere! <br> Manage them through our easy-to-use online wallet, spend them with a swipe of the Zantepay debit Card, or store them free. Zantepay cryptos are stored in Cold Storage. </div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row p-tb-40">
            ...
            <div class="col-md-6 vertical-middle-col content-center">
              <div class="lp-content-col">
                <h3 class="h2 headline">Beginning of the ZanteCoin pre-sale <span>November 1st</span></h2>
                <p>Pre-ICO STARTS 30.000.000 of the tokens will be distributed during pre-ico. Start of pre-ordering Debit card.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row p-tb-40">
            ...
            <div class="col-md-6 vertical-middle-col content-center">
              <div class="lp-content-col">
                ...
                <p>Visa debit card launch. 50+ currencies integration with Debit card and Wallet. Automatic highest exchange rate.</p>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row row-revert">
              ...
              <div class="col-md-5 vertical-middle-col">
                ...
                <ul class="styl-list">
                  <li>The ZanteWallet application will let you purchase, sell, send, receive and exchange your ZanteCoins in the simplest and safest way possible.</li>
                  <li>Its beauty and its ease of use.</li>
                  <li>Your latest ZanteCard transactions or your exchange history.</li>
                  <li>You will also have the option to manage 50+ cryptocurrencies directly from your ZanteWallet and assign your wallets to your ZanteCard according to the selected preferences.</li>
            ...
            <div class="row lp-row-1">
              <div class="col-lg-5 col-md-6 content-center">
                ...
                <div class="text-center">
                  ...
                  <p>Invite a friend to pre-order debit card. <br> RECEIVE 600ZNX WHEN PREORDER IS FINISHED! <br> Your friend gets 400ZNX.</p>
                </div>
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <p>Mardo is an entrepreneur and a visionary. He is passionate about technology, advocate for the digital currency. His recent projects range from electrical car design to AI development. He has a long time experience in sale and marketing.</p>
            </div>
            <div class="col-lg-4">
              ...
              <p>Lena, BA, has an impressive product marketing and sales background. Previously worked in media, technology and telecom branch for the brands like HP and Nokia. She then  moved on to online ased business and recently into the fin tech branch.</p>
            </div>
            <div class="col-lg-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <input class="lp-form-input" type="text" name="name" placeholder="Name">
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    <input class="lp-form-input" type="email" name="email" placeholder="Email">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <textarea class="lp-form-textarea" rows="5" name="message" placeholder="Your message"></textarea>
              </div>
              <div class="text-center">
    ...
    <div class="logon-modal mfp-hide" id="sign-in-modal">
      <div class="logon-modal-container">
        ...
        <div class="social-btns">
          <a href="" class="btn btn--facebook"><i></i> Sign In With Facebook</a>
          <a href="" class="btn btn--google"><i></i> Sign In With Google</a>
        </div>

        <div class="or-horizontal">or</div>

        <div class="err-container login_err">
          <span id="login_err" >Error</span>
        </div>
        <div class="err-container login_err">
          <span id="login_err_msg" >Enter email and password.</span>
        </div>

        <form id='frm_signin' action="<?php echo LOG_IN_PATH . '/userAccount.php'; ?>">
          <div class="logon-group">
            <input id="login_email" class="logon-field" type="email" name="email" placeholder="Email">
          </div>
          <div class="logon-group">
            <input id="login_password" class="logon-field" type="password" name="password" placeholder="Password">
          </div>
    ...
    <div class="logon-modal mfp-hide" id="sign-up-modal">
      <div class="logon-modal-container">
        ...
        <div class="err-container signup_err">
          <span id="span_err" >Error</span>
        </div>
        <div class="err-container signup_err">
          <span id="span_msg" >All fields are required, please fill all the fields.</span>
        </div>
       
        <form id="frm_signup" >
          <div class="logon-group">
            <input class="logon-field" id="signup_email" type="email" name="email" placeholder="Email" required="">
          </div>
          <div class="logon-group">
            <input class="logon-field" id="signup_pwd" type="password" name="password" placeholder="Password" required="">
          </div>
          <div class="logon-group">
            <input class="logon-field" id="signup_cnf_pwd" type="password" name="confirm-password" placeholder="Confirm Password" required="">
          </div>
          <div class="logon-submit">
            <input class="btn btn--shadowed-light btn--260" type="submit" name="signupSubmit" value="Sign Up">
          </div>
    ...
    <div class="logon-modal mfp-hide" id="confirm-modal">
      <div class="logon-modal-container">
        ...
        <a id="email_send_link" href="<?php echo LOG_IN_PATH . '/sendAccountVerifyMail.php'?>" class="btn btn--shadowed-light btn--260">Resend Email</a>
      </div>
    </div>

    <div class="spin-container" id="spin" style="display:none">
      <div class="la-ball-atom la-2x cls-spin">
        <div></div>
        <div class="coin"></div>
        <div class="coin"></div>
        <div class="coin"></div>
