...
var sendActivationEmail = function sendActivationEmail(uid) {
    axios.post('/activate-account', qs.stringify({
        uid: uid
    }));
};
...
$(document).ready(function () {
        ...
        $('.js-popup-link').magnificPopup({
            ...
            callbacks: {
                ...
                elementParse: function elementParse(item) {
                    $(item.src).find('form').each(function (index, element) {
                        return clearForm($(element));
                    });
                }
            }
        });
    ...
    $('#frm_signin').on('submit', function (event) {
        ...
        axios.post('/account/login', qs.stringify(credentials)).then(function (response) {
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_signin input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_signup').on('submit', function (event) {
        ...
        axios.post('/account/register', qs.stringify(credentials)).then(function (response) {
            hideSpinner(button);
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_signup input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $("#frm_invite_signup").on('submit', function (event) {
        ...
        axios.post('/account/register', qs.stringify(credentials)).then(function (response) {
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_invite_signup input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_forgot_password').on('submit', function (event) {
        ...
        axios.post('/account/reset-password', qs.stringify(credentials)).then(function () {
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_forgot_password input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_change_password').on('submit', function (event) {
        ...
        axios.post('/account/save-password', qs.stringify(credentials)).then(function (response) {
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_change_password input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_ico_registration').on('submit', function (event) {
        ...
        axios.post('/ico-registration', qs.stringify(registration)).then(function (response) {
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_ico_registration input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_investor').on('submit', function (event) {
        ...
        axios.post('/seed-investor', qs.stringify(registration)).then(function () {
            hideSpinner(button);
            ...
            $.each(errors, function (field, error) {
                ...
                $('#frm_investor input[name="' + field + '"]').after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_contact').on('submit', function (event) {
        ...
        axios.post('/contact-us', qs.stringify({
            ...
            $.each(errors, function (field, error) {
                ...
                $('#contact-' + field).after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_ticket').on('submit', function (event) {
        ...
        axios.post('/question', qs.stringify({
            ...
            $.each(errors, function (field, error) {
                ...
                $('#ticket_user_' + field).after($('<span />').addClass('error-text').text(error));
            });
        });
    });
    ...
    $('#frm_idea').on('submit', function (event) {
        ...
        axios.post('/question', qs.stringify({
            ...
            $.each(errors, function (field, error) {
                ...
                $('#idea_user_' + field).after($('<span />').addClass('error-text').text(error));
            });
        });
    });
});
