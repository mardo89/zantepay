...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <span class="preheader"
          style="display: none !important; visibility: hidden; opacity: 0; color: #fff; height: 0; width: 0; font-size: 1px;">You’ve been invited to join ZANTEPAY and pre-order a totally free debit card. Connected to your ZANTEPAY wallet, the card will allow you to make purchases in Bitcoin, Litecoin, Ethereum and Zantecoin everywhere in the world. After pre-order is finished, you’ll get 400 ZNX as a bonus!</span>
        ...
        <tr>
            <td align="center" bgcolor="#f0f0f0" style="background-color: #f0f0f0;">
                ...
                <table align="center" cellpadding="0" cellspacing="0" width="100%" border="0" class="table600"
                    ...
                    <tr>
                        <td align="center" valign="top" height="800" background="{{ url('/') . "/images/Bg_gr.png" }}" bgcolor="#ffffff"
                            style="height:800px; background-image:url('{{ url('/') . "/images/Bg_gr.png" }}') 50% 0% no-repeat;background-size:cover;box-shadow: 0px 3px 5px 0px rgba(0, 0, 1, 0.3);border-radius: 10px;border:1px solid #e1e1e1;background-color: #ffffff;">
                            <!--[if gte mso 9]>
                            <v:image xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"
                                     style=" border: 0;display: inline-block; width: 600px; height: 800px;"
                                     src="{{ url('/') . "/images/Bg_gr.png" }}"/>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                        ...
                                                        is finished, you’ll get 400 ZNX as a bonus!
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top"
                                                                    ...
                                                                    <span style="color:#0566c1;font-size: 12px;">{{ $referralLink }}</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!--[if mso]>
                                                    ...
                                                    <td align="center" height="100%" valign="top" width="100%" style="padding: 0;">
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    <a href="#" target="_blank" style="outline: none; border: 0;"><img
                                                                                src="{{ url('/') . "/images/Fb.png" }}" width="42"
                                                                                height="42"
                                                                ...
                                                                <td align="center" valign="top">
                                                                    <a href="#" target="_blank" style="outline: none; border: 0;"><img
                                                                                src="{{ url('/') . "/images/Tw.png" }}" width="42"
                                                                                height="42"
                                                                                style="display:block;outline:0;border:0;width:42px;height:42px"
                                                                                alt="Twitter"></a>
                                                                </td>
                                                                <td align="center" valign="top">
                                                                    <a href="#" target="_blank" style="outline: none; border: 0;"><img
                                                                                src="{{ url('/') . "/images/Email.png" }}" width="42"
                                                                                height="42"
                                                                                style="display:block;outline:0;border:0;width:42px;height:42px"
                                                                                alt="Email"></a>
                                                                </td>
                                                                <td align="center" valign="top">
                                                                    <a href="#" target="_blank" style="outline: none; border: 0;"><img
                                                                                src="{{ url('/') . "/images/Bit.png" }}" width="42"
                                                                                height="42"
                                                                                style="display:block;outline:0;border:0;width:42px;height:42px"
                                                                                alt="Bitcoin"></a>
                                                                </td>
                                                        ...
                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" valign="top"
                                                                    ...
                                                                    <a href="{{ asset('storage/Zantepay_Terms_and_Conditions.pdf') }}"
                                                                       style="outline: none; border: 0; color: #bcbcbc;text-decoration: none;">Terms
                                                                        &amp; Conditions</a>
                                                                </td>
                                                                <td align="right" valign="top"
                                                                    style="font-family:Verdana, Arial, sans-serif; font-size: 14px; color: #bcbcbc; line-height: 36px; font-weight: normal;">
                                                                    <a href="{{ asset('storage/Zantepay_Privacy_Policy.pdf') }}"
                                                                       style="outline: none; border: 0; color: #bcbcbc;text-decoration: none;">Privacy
                                                                        Policy</a>
                                                                </td>
                                                            </tr>
                                                        </table>
