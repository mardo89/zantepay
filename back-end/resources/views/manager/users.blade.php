			...
			<form id="search_user_frm">
						...
						<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<div class="date-picker-wrap">
											<input class="input-field date-picker-inp" type="text" name="date_from_filter" data-toggle="datepicker"
											       placeholder="From">
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										<div class="date-picker-wrap">
											<input class="input-field date-picker-inp" type="text" name="date_to_filter" data-toggle="datepicker"
											       placeholder="To">
										</div>
									</div>
								</div>
				...
				<div class="dashboard-group">
					<div class="row">
						...
						<div class="col-lg-3">
							<button id="import_users" type="button" class="mb-20 btn btn--medium btn--shadowed-light btn--full-w">
								Import to CSV
							</button>
						</div>
					</div>
