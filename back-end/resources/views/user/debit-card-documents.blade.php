        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <form id="dc_documents">
                        <div class="step2-container">
                            <div class="mb-15">Your passport / ID / driver’s license:</div>
                            ...
                            <div class="drag-drop-area">
                                <div class="drag-drop-container">
                                    ...
                                    <label>
                                        ...
                                        <input id="document-files" type="file" name="files[]" multiple="multiple" title='Click to add Files'>
                                    </label>
                            ...
                            <div class="card-submit">
                                <div class="card-submit-wrap">
                                    <a href="/user/debit-card" class="card-back">Back</a>
