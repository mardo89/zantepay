                    ...
                    <div class="accordion js-accordion">
                        ...
                        <div class="accordion-group">
                            ...
                            <div class="accordion__body" id="ac-item5">
                                <p>You can start KYC verification any time you want. You can buy tokens without KYC, but you won ´t be able to withdraw your tokens without KYC verification.</p>
                            </div>
                        </div>
                        <div class="accordion-group">
                            <div class="accordion__head">
