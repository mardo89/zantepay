    ...
    <header class="header header-lp">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-xl-6">
                        The only official URL for Zantepay is <a href="https://zantepay.com">https://zantepay.com</a>.
                        If you receive
                        confirmation
                        of your participation in the Token Sale, the only valid email is <a
                                href="mailto:support@zantepay.com">support@zantepay.com</a>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <ul class="social-list">
                                    <li><a target="_blank" href="https://www.facebook.com/ZANTEPAY/"><i
                                                    class="fa fa-facebook"></i></a></li>
                                    <li><a target="_blank" href="https://twitter.com/zantepay"><i
                                                    class="fa fa-twitter"></i></a></li>
                                    <li><a href="mailto:support@zantepay.com"><i class="fa fa-envelope"></i></a></li>
                                    <li><a target="_blank" href="https://t.me/zantepay_ico"><i
                                                    class="fa fa-telegram"></i></a></li>
                                    <li><a target="_blank" href="https://www.reddit.com/user/ZANTEPAY"><i
                                                    class="fa fa-reddit"></i></a></li>
                                    <li><a target="_blank" href="https://www.instagram.com/zantepay"><i
                                                    class="fa fa-instagram"></i></a>
                                    </li>
                                    <li><a target="_blank" href="https://medium.com/@zantepay"><i
                                                    class="fa fa-medium"></i></a>
                                    </li>
                                    <li><a target="_blank" href="https://bitcointalk.org/index.php?topic=3338226"><i
                                                    class="fa fa-bitcoin"></i></a></li>
                                    <li><a target="_blank"
                                           href="https://www.youtube.com/channel/UCP0ASZEKKM1DzFlhRu3FIpA"><i
                                                    class="fa fa-youtube"></i></a></li>
                                    <li><a target="_blank" href="https://www.linkedin.com/company/zantepay/"><i
        ...
        <div class="header__content white-content">
            <div class="container">
                ...
                <h1 class="h2 header__title text-uppercase">Spend BTC, LTC, ETH and Zantecoin in real life <br> with
                    just one card</h1>
                <div class="row p-t-60">
                    <div class="col-lg-4 text-center">
                        <img src="images/zantepay-card-mobile.png" srcset="images/zantepay-card-mobile@2x.png 2x"
                             alt="Zantepay App">
                    </div>
                    <div class="col-lg-8">
                        <div class="horizontal-btns">
                            <a href="{{ asset('storage/Zantepay_Whitepaper.pdf') }}" target="_blank"
                               class="btn btn--shadowed-dark btn--200"
                            ...
                            @guest
                                <a href="#sign-up-modal" class="js-popup-link btn btn--shadowed-dark btn--200">Buy
                                    Tokens NOW</a>
                            @endguest
                        ...
                        <h3 class="h4 text-uppercase"> 1 ETH = {{ $ico['znxRate'] }} ZNX<br><br> {{ $ico['name'] }} ends
                            in</h3>
                    </div>
                </div>
        ...
        <div class="hp-video-section container text-center white-content">
            ...
            <div>
                <a href="https://www.youtube.com/watch?v=7fuQrhaqXV8" class="js-popup-video">
                    ...
                    <img src="images/zantecoin-thumb.jpg" srcset="images/zantecoin-thumb@2x.jpg 2x"
                         alt="What is ZANTECOIN?">
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        <div class="lp-head">
                            ...
                            <img class="lp-head-lines" src="images/head-lines.png" srcset="images/head-lines@2x.png 2x"
                                 alt="">
                        </div>
                    </div>
        ...
        <div class="lp-section-two white-content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5 text-center">
                        <div class="lp-progress-wrap">
                            ...
                            <div class="js-lp-progress lp-progress-top"
                                 data-percent="{{ $ico['relativeBalance']['value'] }}"></div>
                            <div class="lp-progress-text"> {{ $ico['relativeBalance']['percent'] }}%
                ...
                <div class="lp-section-two-btn">
                    ...
                    @guest
                        <a href="#sign-up-modal" class="js-popup-link btn btn--shadowed-dark btn--260">Buy Tokens
                            NOW</a>
                    @endguest
        ...
        <section class="lp-section-three" id="roadmap">
            <div class="container">
                <div class="row p-b-60">
                    <div class="offset-md-2 col-md-3 vertical-middle-col"><span class="h2 primary-color text-uppercase">Roadmap</span>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="hp-roadmap">
                    <div class="row p-tb-40">
                        <div class="col-md-6 content-center">
                            <div class="lp-image-container">
                                <img src="images/rocket-picture.jpg" srcset="images/rocket-picture@2x.jpg 2x"
                                     alt="Rocket Image">
                            </div>
                        </div>
                        <div class="col-md-6 vertical-middle-col content-center">
                            <div class="lp-content-col">
                                <h3 class="h2 headline">Beginning of the ZANTECOIN pre-sale <span>March 15<sup>th</sup></span>
                                </h3>
                    ...
                    <div class="row row-revert p-tb-40">
                        ...
                        <div class="col-md-6 vertical-middle-col content-center">
                            <div class="lp-content-col">
                                <h3 class="h2 headline">Pre-ICO - ICO III Part
                                    <span>March 15<sup>th</sup> - July 15<sup>th</sup></span>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-tb-40">
                        ...
                        <div class="col-md-6 vertical-middle-col content-center">
                            <div class="lp-content-col">
                                ...
                                <p>Debit card launch. Bitcoin, Litecoin, Ethereum and Zantecoin integration with Debit
                                    card and Wallet.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-revert p-tb-40">
                        <div class="col-md-6 content-center">
                            <div class="lp-image-container2">
                                <img src="images/card.png" srcset="images/card@2x.png 2x" class="lp-visa-card"
                                     width="480px"
                    ...
                    <div class="row lp-row-1">
                        <div class="col-md-6 content-center">
                            <div class="lp-image-container">
                                <img src="images/rocket-image.jpg" srcset="images/rocket-image@2x.jpg 2x"
                                     alt="Rocket Image">
                            </div>
                        </div>
                        <div class="col-md-6 vertical-middle-col content-center">
            ...
            <div class="container">
                ...
                <div class="row p-t-60 mt-20 lp-rate text-center">
                    <div class="col-md-4 mb-20">
                        <a href="https://www.trackico.io/ico/zantepay/" target="_blank" rel="nofollow"
                           title="ZANTEPAY on TrackICO">
                            <img border="0" src="https://www.trackico.io/widget/square/zantepay/400.png" width="150px"
                                 height="150px" alt="ZANTEPAY TrackICO rating">
                        </a>
                    </div>
                    <div class="col-md-4 mb-20">
                        <div>
                        ...
                        <a href="https://icobench.com/ico/zantepay" target="_blank" rel="nofollow"
                           title="Zantepay on ICObench">
                            <img border="0" src="https://icobench.com/rated/zantepay?shape=horizontal&size=m"
                                 width="200" alt="Zantepay ICO rating"/>
                        </a>
                    </div>
                    <div class="col-md-4 mb-20">
                        <a href="https://foundico.com/ico/zantepay.html" target="_blank" rel="nofollow"
                           title="ZANTEPAY on Foundico.com">
                            <img width="150" height="150" border="0" src="https://foundico.com/widget/?p=12067&f=s"
                                 alt="ZANTEPAY score on Foundico.com"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row lp-row-1">
                    <div class="col-sm-6 text-center">
                        ...
                        <h2 class="h2 headline ico-chart-headline">{{ $ico['name'] }}
                            <span>1 ZNX = {{ $ico['euroRate'] }}€</span><span>1 ZNX = {{ $ico['ethRate'] }}
                                ETH</span></h2>
                    </div>
                    <div class="col-sm-6 text-center">
                ...
                <div class="row row-revert">
                    ...
                    <div class="col-md-5 vertical-middle-col">
                        ...
                        <p>Each holder of ZANTECOIN (ZNX) tokens will be entitled to a referral commission, paid weekly;
                            this will be
                ...
                <div class="container">
                    <div class="row row-revert">
                        ...
                        <div class="col-md-5 vertical-middle-col">
                            ...
                            <ul class="styl-list">
                                <li>The ZANTEPAY wallet application will let you purchase, sell, send, receive and
                                    exchange your ZANTECOINs
                                ...
                                <li>You will also have the option to manage Bitcoin, Litecoin, Ethereum and Zantecoin
                                    directly from your
                                    ZANTEPAY wallet and assign your wallets to your ZANTEPAY card according to the
                ...
                <div class="container">
                    <div class="row lp-row-1">
                        <div class="col-lg-5 col-md-6 content-center">
                            ...
                            <div class="text-center">
                                <a href="#sign-up-modal" class="js-popup-link btn btn--shadowed-light">Verify &
                                    Pre-order a FREE Debit
                                    Card</a>
                                <p class="text-regular">Pre-order free debit card and receive 500ZNX!</p>
                                <p class="text-regular">Invite a friend to pre-order debit card. <br> RECEIVE 500ZNX
                                    WHEN PREORDER IS
                        ...
                        <div class="col-md-6 offset-lg-1">
                            ...
                            <ul class="styl-list">
                                <li>Allows making purchases with Bitcoin, Litecoin, Ethereum or Zantecoin everywhere in
                                    the world.
                                </li>
                                <li>Connected directly to your ZANTEPAY wallet.</li>
                                <li>Provides automatic highest trading price from partner exchanges. 1%exchange fee. No
                                    hidden charges.
                                </li>
        ...
        <section class="lp-section-seventh white-content">
            <div class="container">
                <div class="row lp-row-1">
                    ...
                    <div class="col-lg-7">
                        <h2 class="h2 headline">Our goal is to become the biggest cryptocurrency wallet worldwide by the
                            end of 2019</h2>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 vertical-middle-col content-center">
                        <div class="lp-coin-value">
                            <div class="lp-coin-text"> 20% <span
                                        class="h4">ZANTECOINs cashback <br> on all purchases <br> via Debit card</span>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p>Mardo is a visionary, investor and entrepreneur, his expertise in sales and marketing is more
                            than 10 years. He
                            ran couple of successful web projects in Estonia. His latest passion is blockchain and
                            cryptocurrency. Mardo`s
                            talent is to find and recognize the best people for the job to make something great. He
                            believes cryptocurrency
                    ...
                    <div class="col-lg-4">
                        ...
                        <p>Lena, BAA, has an impressive global product marketing and sales background. Previously worked
                            in media,
                            technology and telecom branch for the brands like HP and Nokia. Then she moved on to
                            online-based consulting
                            business and recently into the fin tech branch. Lena believes that her corporate experience,
                            leadership and
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Daniel Raissar <span>CTO</span> <a target="_blank"
                                                                          href="https://www.linkedin.com/in/daniel-raissar-58684848/"
                                                                          class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Daniel is an early adaptor of cryptocurrencies. BScIT from IT College. One of the founding
                            members of Estonian Cryptocurrency Association. Has the experience of trading
                            cryptocurrencies successfully for over 5 years.</p>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Ron Luvistsuk <span>CFO</span> <a target="_blank"
                                                                         ...
                                                                         class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Ron is bringing his experience from SEB Corporate banking. He has more than 20 years of
                            experience in finance,
                            deep understanding of risk, compliance and payment architecture in the EU. Ex CFO at Lukoil
                            Baltic. As an
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Kristi Sild <span>Legal <br> Attorney at Law/ Partner, LEXTAL</span> <a
                                    target="_blank" href="https://www.linkedin.com/in/kristi-sild-16745093/"
                                    class="soc-icon"><i class="fa fa-linkedin-square"></i></a></h3>
                        <p>Kristi is an experienced attorney and leads the legal team of Zantepay project. Kristi is a
                            partner in Lawfirm
                            LEXTAL, one of the biggest lawfirms in Estonia, having also offices in Latvia and Lithuania.
                            Kristi has wide
                            legal experience in fintech field, including regulatory matters and other legal questions
                            related to innovative
                            financing and financial services. Her expertise also covers services related to crypto
                            currencies and ICOs.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/stas.jpg" srcset="images/stas@2x.jpg 2x" alt="Stanislav Ivashchenko">
                        <h3 class="h4">Stanislav Ivashchenko <span>User Experience and Product Design Lead</span> <a
                                    target="_blank" href="https://www.linkedin.com/in/stanislav-ivashchenko-2352054/"
                                    class="soc-icon"><i class="fa fa-linkedin-square"></i></a></h3>
                        <p>Stanislav shapes visual appearance of ZANTEPAY. He possesses more than 6 years of experience
                            in graphic design
                            and usability across all media and has a passion for bringing brands to life through great
                            user-centered
                            design.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/alex.jpg" srcset="images/alex@2x.jpg 2x" alt="Alexey Fedorenko">
                        <h3 class="h4">Alexey Fedorenko <span>Front-End Team Lead</span> <a target="_blank"
                                                                                            href="https://www.linkedin.com/in/alexey-ffedorenko/"
                                                                                            class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Alexey makes a great addition to our team with his commercial experience in front-end
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Pavel Boyko <span>Backend Team Lead</span> <a target="_blank"
                                                                                     href="https://www.linkedin.com/in/pavel-boiko-a1123a3/"
                                                                                     class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Pavel runs Advanced Software Development LTD (ASD), a Fintech software vendor. Pavel and his
                            team has more than
                            10 year experience in delivering the variety of web applications, software engineering
                            solutions, big data
                            analytics, mastering the hardest design, UX/UI tasks. Pavel believes in blockchain and the
                            huge potential of the
                            industry.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/alexander.jpg" srcset="images/alexander@2x.jpg 2x" alt="Alexander Harutunian ">
                        <h3 class="h4">Alexander Harutunian <span>Smart Contracts / Project Manager</span> <a
                                    target="_blank" href="https://www.linkedin.com/in/alex113115/" class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Corporate finance and economics professional, specializing in Fintech. Previously, Alexander
                            had a senior auditor
                            role at KPMG, led retail and banking sector engagements. He has MBA from American University
                            of Armenia. </p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/levon.jpg" srcset="images/levon@2x.jpg 2x" alt="Levon Hayrapetyan">
                        <h3 class="h4">Levon Hayrapetyan <span>Smart Contracts Developer</span> <a target="_blank"
                                                                                                   href="https://www.linkedin.com/in/levonhayrapetyan/"
                                                                                                   class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Levon is an experienced software engineer specializing in cloud technologies and blockchain.
                            Levon brings in
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Oleg Pyvovarenko <span>DM Team Lead</span> <a target="_blank"
                                                                                     href="https://www.linkedin.com/in/oleg-pyvovarenko-b307b324/"
                                                                                     class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Data-driven product marketing manager with 7+ years of experience in various global projects.
                            Experienced in
                            gambling, betting, finance projects, ICO and crypto exchanges. Worked with huobi.pro,
                            Aeron.aero, xchange.io
                            etc. </p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/vadim.jpg" srcset="images/vadim@2x.jpg 2x" alt="Vadim Ivanenko">
                        <h3 class="h4">Vadim Ivanenko <span>Bounty Manager</span> <a target="_blank"
                                                                                     href="https://www.linkedin.com/in/vivanenko/"
                                                                                     class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a></h3>
                        <p>Vadim is a serial entrepreneur, blockchain evangelist and crypto investor. He is a CEO and
                            Founder at Luft,
                            offering B2B solutions for the blockchain startups. His role at ZANTEPAY is to design and
                            lead its Bounty
                            Programme.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Dmitri Laush <span style="font-size:0.83em;">Foreign Exchange, Integration Partner, Co-Founder of Admiral Markets</span>
                            <a target="_blank" href="https://www.linkedin.com/in/dmitrilaush/" class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a>
                        </h3>
                        <p>Experienced Investor with a demonstrated history of working 15 years in the financial
                            services industry. Co-
                            founder of Admiral Markets investment firms operating under the Admiral Markets trademark.
                            Dmitri is an advisor
                            and investor in various blockchain projects and startups. Founder of own crypto fund and a
                            few blockchain
                            projects. Entrepreneur, Blockchain Evangelist and a true believer that decentralization,
                            peer-to-peer (P2P)
                            governance systems and cryptocurrencies can help define a new path for the progress of
                            humanity.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/cristobal.jpg" srcset="images/cristobal@2x.jpg 2x" alt="Cristobal Alonso">
                        <h3 class="h4">Cristobal Alonso <span
                                    style="font-size:0.83em;">Global CEO @ Startup Wise Guys</span>
                            <a target="_blank" href="https://www.linkedin.com/in/cristobalalonso/" class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a>
                        </h3>
                        <p>Cristobal is the Global Capo of Startup Wise Guys – Europe’s leading B2B accelerator and the
                            leading acceleration
                            platform for global founders and preferred deal flow partner for VC funds in Northern Europe
                            and the CEE.
                            Cristobal’s unique background combines extensive CxO experience in different mobile
                            operators in Europe, leading
                            several transformations and turnarounds, together with CEO startup experience both in B2B
                            and B2C environments.
                            Cristobal has been involved in more than 15 startups in 20 different countries as a founder,
                            early CEO,
                            investor, and lately as an advisor.</p>
                    </div>
                    <div class="col-lg-4">
                        <img src="images/rauno.jpg" srcset="images/rauno@2x.jpg 2x" alt="Rauno Klettenberg">
                        <h3 class="h4">Rauno Klettenberg <span
                                    style="font-size:0.83em;">Board Member at FinanceEstonia </span>
                            <a target="_blank" href="https://www.linkedin.com/in/rauno-klettenberg-48521a30/"
                               class="soc-icon"><i class="fa fa-linkedin-square"></i></a>
                        </h3>
                        <p>Ex Chairman of the Board at Nasdaq Tallinn. Ex General Manager of Handelsbanken. Member of
                            the Board at Finance
                            Estonia. Rauno is an experienced Board Member with a demonstrated history of working in the
                            financial services
                            industry. Expert in Asset Management, Management, Mergers & Acquisitions, and Financial
                            Risk. He is a strong
                            business development professional with a Master's Degree focused in Accounting and Finance
                            from Estonian
                            Business School.</p>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4">Juan Alonso-Villalobos <span style="font-size:0.83em;">Fintech Programs Managing Director  @ Startup Wise Guys</span>
                            <a target="_blank" href="https://www.linkedin.com/in/juanalonsovillalobos/"
                               class="soc-icon"><i class="fa fa-linkedin-square"></i></a>
                        </h3>
                        <p>Spanish serial entrepreneur. More than 20 years in retail banking and payments
                            interationally. Senior Advisor to
                    ...
                    <div class="col-lg-4">
                        ...
                        <h3 class="h4 h4--3row">Farid Singh <span style="font-size:0.83em;">Innovation Consultant, User centric Product Manager, Blue Ocean Strategist & Tech Expert</span>
                            <a target="_blank" href="https://www.linkedin.com/in/farid-singh-823b391/" class="soc-icon"><i
                                        class="fa fa-linkedin-square"></i></a>
                        </h3>
                        <p>With over 10 years of experience in TMT and deep tech, Farid focuses on getting new tech to
                            people. He helps move
                            new technology to a mainstream product and leverages the benefits of new technology to drive
                            adoption. </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <a target="_blank" rel="nofollow" href="http://www.kryptoraha.ee">
                            <img src="images/estonian-crypto-association.png"
                                 srcset="images/estonian-crypto-association@2x.png 2x"
                                 alt="estonian crypto association">
                        </a>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <a target="_blank" rel="nofollow" href="https://www.mongodb.com/">
                            <img src="images/mongodb-logo-white.png" srcset="images/mongodb-logo-white@2x.png 2x"
                                 alt="mongoDB">
                        </a>
                    </div>
                </div>
            ...
            <div class="footer-chanels" id="channels">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-6">
                        <h4><a target="_blank" href="https://bitcointalk.org/index.php?topic=3338226">Bitcointalk</a>
                        </h4>
                        <a target="_blank" href="https://bitcointalk.org/index.php?topic=3338226"><i
                                    class="fa fa-bitcoin"></i></a></li>
                    </div>
                    <div class="col-sm-3 col-6">
                        <h4><a target="_blank"
                               href="https://www.youtube.com/channel/UCP0ASZEKKM1DzFlhRu3FIpA">YouTube</a></h4>
                        <a target="_blank" href="https://www.youtube.com/channel/UCP0ASZEKKM1DzFlhRu3FIpA"><i
                                    class="fa fa-youtube-play"></i></a></li>
                    </div>
                    <div class="col-sm-3 col-6">
                        <h4><a target="_blank" href="https://www.linkedin.com/company/zantepay/">LinkedIn</a></h4>
                        <a target="_blank" href="https://www.linkedin.com/company/zantepay/"><i
                                    class="fa fa-linkedin"></i></a></li>
                    </div>
                </div>
            </div>
            ...
            <div class="row footer-cont-group" id="contacts">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="footer-cont-row row">
                        <div class="col-md-6">
                            <div class="footer-cont-text h5">ZANTEPAY OÜ <br> Rävala 19, 10143, <br> Tallinn, Estonia
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="footer-cont-text">For any questions please reach us at <a
                                        href="mailto:support@zantepay.com">support@zantepay.com</a> <br> or fill out the
                                form below:
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input id="contact-name" class="lp-form-input" type="text" name="name"
                                           placeholder="Name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input id="contact-email" class="lp-form-input" type="email" name="email"
                                           placeholder="Email">
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-menu">
                <ul>
                    <li><a href="{{ asset('storage/Zantepay_Terms_and_Conditions.pdf') }}" target="_blank">Terms &
                            Conditions</a></li>
                    <li><a href="{{ asset('storage/Zantepay_Privacy_Policy.pdf') }}" target="_blank">Privacy Policy</a>
                    </li>
...
@section('popups')
    ...
    <div class="logon-modal logon-modal-lg mfp-hide" id="sign-up-preico">
        <div class="logon-modal-container">
            ...
            <div class="logon-modal-text">
                <p>ZANTECOIN’s Token Pre-ICO is created for investors with prior cryptocurrency experience. Please pay
                    attention that the
                    minimum transaction amount is 0.1 ETH. For investors from the US the min investment amount is 10
                    ETH. To apply, please
                    contact <a href="mailto:support@zantepay.com">support@zantepay.com</a>. </p>
                <p>The actual opening date for the ZANTECOIN’s public Token Sale is on March 15<sup>th</sup>, 2018. To
                    participate in
                    ZANTECOIN’s Token Pre-ICO, please enter you email below. You will be notified, once Pre-ICO starts.
                </p>
            </div>
    ...
    <div class="logon-modal mfp-hide" id="confirm-sign-up-preico">
        <div class="logon-modal-container">
            ...
            <div class="logon-modal-text">
                <p>Your application has been submitted. Once the ZANTECOIN pre-ICO starts, you'll get a personal
    ...
    <div class="logon-modal logon-modal-md mfp-hide" id="become-our-seed-investors">
        <div class="logon-modal-container">
            ...
            <div class="logon-modal-text">
                <p>We are starting with ZANTEPAY ICO on 15<sup>th</sup> of March. At the moment we are looking for seed
                    investors, offering
                    ZNX tokens at
                    the discounted price. If you are interested to become a seed investor, please fill out the contact
                    form and we will get
                    back to you.</p>
            </div>
        ...
        <div class="logon-modal-container">
            ...
            <form action="">
                <div class="logon-group text-left">
                    <div class="checkbox">
                        <input type="checkbox" name="" id="check1"><label for="check1">I’ve read, understood and agree
                            with the <a
                ...
                <div class="logon-group text-left">
                    <div class="checkbox">
                        <input type="checkbox" name="" id="check2"><label for="check2">I’ve read and understood with the
                            <a
                ...
                <div class="logon-group text-left">
                    <div class="checkbox">
                        <input type="checkbox" name="" id="check3"><label for="check3">I’ve read, understood and agree
                            with the <a
