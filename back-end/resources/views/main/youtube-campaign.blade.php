...
@section('main')
    ...
    <main class="main main-dashboard">
        <div class="container">
            <h2 class="h2 text-uppercase p-b-60">Video program</h2>
            <div class="mb-20">
            ...
            <div class="mt-40 p-t-30">
                <h2 class="h2 mb-20 text-uppercase">Video</h2>
                ...
                <p class="mt-40 h4"><a target="_blank" href="https://docs.google.com/forms/d/1_XDcC9ds9cjs8IPIwF49Kl2_UKRYpzcG8Ns8vw5I_Iw/viewform?edit_requested=true">Fill the form to ADD </a></p>
